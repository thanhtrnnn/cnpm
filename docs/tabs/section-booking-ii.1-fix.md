...
| Ngoại lệ | 3a. Khách hàng không đến đúng giờ đặt: 3a.1 Nhân viên chọn hủy booking hoặc gia hạn thời gian chờ. 3a.2 Nếu hủy, hệ thống chuyển trạng thái booking sang "Đã hủy", phòng về "Trống". 6a. Phòng đang được dọn dẹp: 6a.1 Hệ thống hiển thị thông báo "Phòng đang dọn dẹp, vui lòng chờ.". 6a.2 Nhân viên chờ hoặc chuyển khách sang phòng khác. 6b. Thông tin booking không khớp: 6b.1 Nhân viên yêu cầu khách hàng cung cấp lại thông tin xác minh. 6b.2 Nếu không khớp, nhân viên liên hệ quản lý. |
...
| Ngoại lệ | 3a. Phòng có order dịch vụ chưa được xác nhận: 3a.1 Hệ thống cảnh báo "Có [N] order chưa xác nhận.". 3a.2 Nhân viên xác nhận hoặc hủy các order trước khi tiếp tục. 5a. Khách hàng không phải hội viên: 5a.1 Hệ thống bỏ qua bước áp dụng ưu đãi hạng. 8a. Khách hàng khiếu nại hóa đơn: 8a.1 Nhân viên chỉnh sửa hóa đơn (thêm/bớt mục) trước khi xác nhận. 8a.2 Nếu cần, nhân viên liên hệ quản lý để xử lý. 9a. Thanh toán chuyển khoản thất bại: 9a.1 Hệ thống hiển thị lỗi, yêu cầu chọn lại phương thức. 9a.2 Nhân viên xác nhận với khách và thử lại. |
...
| Ngoại lệ | 4a. Không tìm thấy booking: 4a.1 Nhân viên yêu cầu khách hàng cung cấp lại thông tin. 4a.2 Nếu vẫn không tìm thấy, thông báo "Không tìm thấy booking phù hợp.". 7a. Booking đã quá thời gian cho phép hủy: 7a.1 Hệ thống hiển thị "Booking đã quá thời gian hủy, không thể hủy.". 7a.2 Nhân viên thông báo cho khách hàng. 9a. Khách hàng yêu cầu hoàn tiền cọc: 9a.1 Nhân viên kiểm tra chính sách hoàn tiền. 9a.2 Nếu đủ điều kiện, nhân viên xử lý hoàn tiền thủ công (ngoài hệ thống). |
